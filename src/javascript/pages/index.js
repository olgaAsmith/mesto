...
const popupEditAvatar = new PopupWithForm(
  document.querySelector(".popup_set-new-avatar"),
  setNewAvatar
);
popupEditAvatar.setEventListeners();
const popupDeleteCard = new PopupDeleteCard(
  document.querySelector(".popup_delete-card-question")
);
popupDeleteCard.setEventListeners();
const userInfo = new UserInfo({
  name: ".account__name",
  about: ".account__profession",
...
function getValueToForm({ name, about }) {
...
function clickOnLike(cardId, card, liked) {
  //*get true/false from like/unlike
  if (liked) {
